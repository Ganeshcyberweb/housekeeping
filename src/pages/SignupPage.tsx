      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Get started with the Housekeeping Shift Planner
          </p>
        </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-800">
                    Sign up using your Google account to get started. Your
                    account will need to be approved by an administrator before
